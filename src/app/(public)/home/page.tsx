...
function Eyebrow({ children }: { children: React.ReactNode }) {
  return (
    <span
      ...
      style={{ fontFamily: "var(--font-mono)", color: "#0f62fe", letterSpacing: "0.14em" }}
    >
      {children}
    </span>
  );
...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col bg-white">
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-16 mb-16 items-end">
            ...
            <p className="text-lg leading-relaxed" style={{ color: "#525252" }}>
              Quatro caminhos estruturados, cada um com currículo, projetos e mentoria necessários para chegar preparado ao mercado.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-px bg-[#e0e0e0] border border-[#e0e0e0]">
            {[
              {
                n: "01",
              ...
              <Link
                key={track.n}
                href="/cursos"
                className="group block bg-white p-10 relative hover:bg-[#f4f4f4] transition-colors"
              >
                {/* Arrow button top-right */}
                <div
                  className="absolute top-10 right-10 w-10 h-10 flex items-center justify-center transition-all border group-hover:bg-[#0f62fe] group-hover:border-[#0f62fe] group-hover:text-white"
                    ...
                    <div className="grid grid-cols-2 gap-4 pt-5" style={{ borderTop: "1px solid #e0e0e0" }}>
                      <div>
                        <div
                          ...
                          style={{ fontFamily: "var(--font-mono)", color: "#8d8d8d", letterSpacing: "0.1em" }}
                        >
                          Duração
                        </div>
      ...
      {/* ── Outcomes (dark) ────────────────────────────────────── */}
      <section className="py-24 px-4 md:px-8" style={{ background: "#161616", color: "#fff" }}>
        <div className="mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-16 mb-16 items-end">
            <div>
              <Eyebrow>Resultados que importam</Eyebrow>
              <SerifH2 light>
                O que acontece{" "}
            ...
            <p className="text-lg leading-relaxed" style={{ color: "#c6c6c6" }}>
              Acompanhamos a trajetória dos nossos alunos após a conclusão. Os dados refletem turmas formadas entre 2024 e 2026.
            </p>
          </div>

          <div className="grid grid-cols-2 lg:grid-cols-4 gap-px border border-[#393939]" style={{ background: "#393939" }}>
            {[
              { v: "87%", l: "Conseguem vaga ou promoção em até 6 meses", n: "01" },
              { v: "+42%", l: "Aumento médio de salário após a formação", n: "02" },
              { v: "3,2×", l: "Mais chamadas para entrevistas com portfólio", n: "03" },
              { v: "R$ 11k", l: "Salário mediano em primeiro cargo júnior", n: "04" },
            ].map((s) => (
              <div key={s.n} className="relative p-8 md:p-10" style={{ background: "#161616" }}>
                <span
                ...
                <div className="text-sm leading-relaxed" style={{ color: "#c6c6c6", maxWidth: 220 }}>{s.l}</div>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-px bg-[#e0e0e0] border border-[#e0e0e0]">
            {[
              ...
              <div key={step.step} className="bg-white p-10 flex flex-col">
                ...
                <span
                  ...
                  style={{ fontFamily: "var(--font-mono)", color: "#c6c6c6" }}
                >
                  PASSO {step.step}
                </span>
      ...
      <section className="py-24 px-4 md:px-8 border-b border-[#e0e0e0]" style={{ background: "#f4f4f4" }}>
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-[#e0e0e0] border border-[#e0e0e0]">
            {[
              {
                q: "Em quatro meses eu saí de análise de dados em planilha para deploy de modelos em produção. A trilha de MLOps foi decisiva.",
                n: "Juliana Almeida",
                r: "ML Engineer · Nubank",
                g: ["#f4d3b3", "#c89474"],
              },
              {
                q: "Os projetos reais foram o que me destacaram em entrevista. Mostrei código, métricas e decisões — não só certificados.",
                n: "Thiago Nakamura",
                r: "Data Scientist · iFood",
                g: ["#b3d4ff", "#4589ff"],
              },
              {
                q: "A mentoria semanal me tirou de travas que eu teria sozinho. Paguei o curso em três meses com o aumento do novo cargo.",
                n: "Leticia Freitas",
                r: "AI Engineer · Stone",
                g: ["#b3e4c4", "#4a8a60"],
              },
            ].map((t, i) => (
              <figure key={i} className="bg-white p-10 m-0 flex flex-col">
                <span
                  className="mb-6"
                  style={{
                    fontFamily: "var(--font-serif), Georgia, serif",
                ...
                <blockquote
                  className="text-base leading-relaxed mb-8 flex-1 m-0"
                  style={{ color: "#161616" }}
                >
                  {t.q}
                </blockquote>
      ...
      <section className="py-24 px-4 md:px-8 border-b border-[#e0e0e0]" style={{ backgroundColor: "#fff" }}>
        <div className="mx-auto max-w-7xl">
          <div className="grid md:grid-cols-2 gap-16 mb-16 items-end">
            ...
            <p className="text-lg leading-relaxed" style={{ color: "#525252" }}>
              Cada trilha inclui projetos práticos com código real que você pode mostrar para empregadores.
            </p>
          </div>
